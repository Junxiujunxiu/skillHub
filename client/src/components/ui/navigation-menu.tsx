/* =========================================================
   ...
   - Built on top of Radix UI Navigation Menu primitives
   - Provides an accessible, animated, and customizable navigation system
   - Includes Trigger, Content, Viewport, and Indicator components
   ========================================================= */
   ...
   /* ===================== ROOT ===================== */
   /**
    * NavigationMenu - main container for the navigation menu
    * @example
    *  <NavigationMenu>
